...
function Inicio_C() {
  const cerrarSesion = () => {
    ...
    // Eliminar cookies de clientes
    cookies.remove('cliente_id', { path: "/" });
            ...
            <div className="col-lg-2 col-md-6 col-sm-6">
              ...
              <div className="menu-container">
                <ul className="link_icon">
                  ...
                  <li><Link to="/perfil_c">Perfil</Link></li>
                  <li><Link to="/servicios_c">Servicios</Link></li>
                  <li><Link to="/citas_c">Agendar Citas</Link></li>
                  <li><Link to="/vehiculos_c">Mis vehículos</Link></li>
                </ul>
              </div>
            </div>
          </div>
