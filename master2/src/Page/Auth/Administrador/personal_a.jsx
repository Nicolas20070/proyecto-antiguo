...
function Personal_A() {
  ...
  const [Prsonal, setPrsonal] = useState({
  ...
  const handleSaveChanges = () => {
    ...
    console.log('Datos guardados:', Prsonal);
  };
        ...
        >
          <ul className="sidebar-menu" id="nav-accordion">
            ...
            <div>
              ...
              <li className="sub-menu">
                <Link class="active" to="/personal_a">
  ...
  <div className="container">
    ...
    <div className="service-box2">
      ...
      <p><strong>Estado de Empleo:</strong> Activo</p>
      <ul>
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h4 className="modal-title" id="addModalLabel">Agregar Personal</h4>
                ...
                <div className="modal-body">
                  <form id="addVehicleForm">
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="addMarca" placeholder="Ingrese el nombre  completo del Trabajador " required />
                    </div>
                    <div className="form-group">
                      <label htmlFor="addPlaca">Cargo</label>
                      <input type="text" className="form-control" id="addPlaca" placeholder="Ingrese el cargo" required />
                    </div>
                    <div className="form-group">
                      <label htmlFor="addPropietario">edad</label>
                      <input type="number" className="form-control" id="addPropietario" placeholder="Ingrese la edad" required />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      <label htmlFor="addFechaRegistro">CC</label>
                      <input type="number" className="form-control" id="addFechaRegistro" placeholder="Ingrese la cedula de ciudadania" required />
                    </div>
                    <div className="form-group">
                      <label htmlFor="addFechaRegistro">Estado</label>
                      <input type="text" className="form-control" id="addFechaRegistro" placeholder="Ingrese el estado" required />
                    </div>
              <br />
                    <button type="button" className="btn btn-primary" onClick={handleAddChanges}>Agregar Trabajador</button>
                  </form>
                </div>
              </div>
            </div>
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="form-group mb-3">
                    <p><strong>Correo:</strong> {personal.correoelectronico}</p>
                  </div>
                  <div className="form-group mb-3">
                    <p><strong>Telefono:</strong> {personal.telefono}</p>
                  </div>
                  <div className="form-group mb-3">
                    <p><strong>CC:</strong> {personal.cc}</p>
                  </div>
                  <div className="form-group mb-3">
                    <p><strong>Estado del Empleado:</strong> {personal.estado}</p>
                  </div>
                </div>
  ...
  {/* Edit Inventario modal */}
   <div className="modal fade" id="editModal" tabIndex={-1} role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
              <div className="modal-dialog" role="document">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="editModalLabel">Editar Personal</h5>
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div className="modal-body">
